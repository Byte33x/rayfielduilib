...
local RayfieldFolder = "Rayfield"a
...
local RayfieldLibrary = {
	...
	Theme = {
		Default = {
			...
			Background = Color3.fromRGB(28, 36, 56),
			Topbar = Color3.fromRGB(48, 56, 65),
			Shadow = Color3.fromRGB(20, 20, 20),

			NotificationBackground = Color3.fromRGB(28, 36, 56),
			NotificationActionsBackground = Color3.fromRGB(230, 230, 230),

			TabBackground = Color3.fromRGB(28, 36, 56),
